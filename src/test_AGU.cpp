...
void test_AGU(){
    ...
    BitOperate BR;
    ofstream ofs_AGU_k1_BN, ofs_AGU_k1_MA;


    ofs_AGU_k1_BN.open("../tb_data/AGU/AGU_algo_bank.txt");
    ofs_AGU_k1_MA.open("../tb_data/AGU/AGU_algo_MA.txt");
    long long delta = log2(pow_radix_k1);

    if(!ofs_AGU_k1_BN.is_open() || !ofs_AGU_k1_MA.is_open()){
